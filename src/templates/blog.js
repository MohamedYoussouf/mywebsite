    ...
    const postList = props.data.allMarkdownRemark.edges.map(post=>{
        return (
            <div className="py-5 px-0 md:flex mb-5 border-b-2 border-gray-300">
              <Img className="w-auto md:w-1/4 md:ml-4 self-start rounded-lg mb-5 md:mb-0" fluid={post.node.frontmatter.featuredImage.childImageSharp.fluid}/>
              <div className="w-auto md:w-4/5 md:pr-5">
